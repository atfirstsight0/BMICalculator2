package com.meguillaume.bmicalculator;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Sets the cursor to height edittext (other option was just placing
        // height edittext about weight edittext in xml.
        // height_value.setFocusableInTouchMode(true);
